...
for rep=1:length(Dir)
    ...
    load([Dir(rep).name '/results/vanilla_vae_compl_data_test1.mat'])
ref=x_sample;
...
load([Dir(rep).name '/results/vanilla_vae_compl_data_test2.mat'])
...
load([Dir(rep).name '/results/vanilla_vae_compl_data_test3.mat'])
...
load([Dir(rep).name '/results/vanilla_vae_compl_data_test4.mat'])
